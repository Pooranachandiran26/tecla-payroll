                                                ...
                                                <table className="data-table" style={{ fontSize: "0.8rem" }}>
                                                    ...
                                                    <tbody>
                                                        {items.map((item) => {
                                                            ...
                                                            const deduct = parseFloat(item.employee_pf || 0) + parseFloat(item.employee_vpf || 0) + parseFloat(item.employee_esi || 0) + parseFloat(item.professional_tax || 0) + parseFloat(item.lwf_deduction || 0) + parseFloat(item.tds_deduction || 0) + parseFloat(item.loan_emi_deduction || 0);
