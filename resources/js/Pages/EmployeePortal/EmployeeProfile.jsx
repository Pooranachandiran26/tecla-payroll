...
export default function EmployeeProfile({ employee: empProp, pendingBankRequest, salaryRevisions }) {
    ...
    const styles = {
        ...
        avatarLg: {
            ...
            color: 'var(--primary-navy, #1E3A8A)', display: 'flex', alignItems: 'center', justifyContent: 'center',
        ...
        <RoleGuard allowedRoles={['employee']}>
            <AuthenticatedLayout>
                ...
                <div style={styles.pageContainer}>
                    {/* Fixed Hero Section (Always visible above tabs) */}
                    ...
                    <div style={{
                        ...
                        {[
                            ...
                            { id: 'identity', label: 'Identity & Bank', icon: <Landmark size={16} /> },
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    color: activeTab === tab.id ? 'var(--primary-navy, #1E3A8A)' : '#64748B',
                                    borderBottom: activeTab === tab.id ? '3px solid var(--primary-navy, #1E3A8A)' : '3px solid transparent',
                        ...
                        <div style={styles.grid}>
                            ...
                            <div style={styles.card}>
                                <h3 style={styles.cardTitle}>
                                    <User size={18} color="#64748b" /> Personal Information
                                </h3>
                                <div>
                            ...
                            <div style={styles.card}>
                                <h3 style={styles.cardTitle}>
                                    <Phone size={18} color="#64748b" /> Contact & Address
                                </h3>
                                <div>
                                    <div style={styles.row}>
                            ...
                            <div style={styles.card}>
                                <h3 style={styles.cardTitle}>
                                    <Briefcase size={18} color="#64748b" /> Employment Details
                                </h3>
                                <div>
                                    <div style={styles.row}>
                        ...
                        <div style={styles.grid}>
                            ...
                            <div style={styles.card}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.75rem' }}>
                                    <h3 style={{ ...styles.cardTitle, borderBottom: 'none', paddingBottom: '0' }}>
                                        <Landmark size={18} color="#64748b" /> Identity & Bank
                                    </h3>
                                ...
                                {pendingBankRequest && (
                                    <div style={{ backgroundColor: '#FEF3C7', color: '#92400E', padding: '0.5rem', borderRadius: '4px', fontSize: '0.8rem', display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                                        <Clock size={16} color="#92400E" /> <strong>Under Review:</strong> Bank change pending.
                                    </div>
                                )}
                                <div>
                                    <div style={styles.row}>
                            ...
                            <div style={styles.card}>
                                <h3 style={styles.cardTitle}>
                                    <FileText size={18} color="#64748b" /> Statutory Profile
                                </h3>
                                <div>
                                    <div style={styles.row}>
                    ...
                    {activeTab === 'documents' && (
                        <div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                                <h3 style={{ ...styles.cardTitle, borderBottom: 'none', paddingBottom: '0', marginBottom: '0' }}>
                                    <FolderOpen size={18} color="#64748b" /> KYC Documents
                                </h3>
                                {employee.status === 'onboarding' && (
                                    <div style={{ fontSize: '0.85rem', color: 'var(--status-warning)', fontWeight: '600', backgroundColor: '#FEF3C7', padding: '0.4rem 0.8rem', borderRadius: '6px', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
                                        <AlertTriangle size={15} color="#92400E" /> Action Required: Pending Verification
                                    </div>
                                )}
                            </div>
                                                ...
                                                <React.Fragment key={idx}>
                                                    <tr style={{ borderBottom: idx === requiredDocsList.length - 1 ? 'none' : '1px solid #f1f5f9', backgroundColor: 'white' }}>
                                                        <td style={{ padding: '1rem 1.25rem', verticalAlign: 'middle' }}>
                                                            <div style={{ fontWeight: '600', color: '#0f172a', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
                                                                <FileText size={15} color="#475569" /> {doc.name}
                                                            </div>
                    ...
                    {activeTab === 'history' && (
                        <div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                                <h3 style={{ ...styles.cardTitle, borderBottom: 'none', paddingBottom: '0', marginBottom: '0' }}>
                                    <TrendingUp size={18} color="#64748b" /> Salary Revision History
                                </h3>
                            </div>
                            <HistoryTimeline revisions={salaryRevisions || []} isAdmin={false} />
                        </div>
                    )}
                </div>
