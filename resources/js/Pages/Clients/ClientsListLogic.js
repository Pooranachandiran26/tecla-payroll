// Auto-extracted logic for ClientsList
...
window.getFilteredClients = getFilteredClients;
window.applyFilters = applyFilters;
window.clearFilters = clearFilters;
window.changePage = changePage;
window.handleRowAction = handleRowAction;
window.updateSummary = updateSummary;
window.toggleAllCheckboxes = toggleAllCheckboxes;
window.updateBulkActions = updateBulkActions;
window.exportCSV = exportCSV;
window.bulkChangeStatus = bulkChangeStatus;
window.bulkAssignAM = bulkAssignAM;
window.bulkSendReminder = bulkSendReminder;
