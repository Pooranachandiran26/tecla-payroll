...
<head>
    <meta charset="utf-8">
    <title>Employee Statutory Profile & Exemption Audit</title>
    <style>
...
<body>
    <table class="header-table">
        <tr>
            <td style="width: 50%;">
                ...
                <div class="meta-text">Employee Statutory Profile & Exemption Audit</div>
            </td>
            <td style="width: 50%;" class="text-right">
                <div class="report-title">Statutory Profile</div>
    ...
    <table class="kpi-table">
        <tr>
            ...
            <td class="kpi-card" style="width: 25%;">
                <div class="kpi-title">EPF Covered</div>
                <div class="kpi-val" style="color: #1e3a8a;">{{ $kpis['pf_covered'] }}</div>
            </td>
            <td class="kpi-card" style="width: 25%;">
                <div class="kpi-title">ESI Covered</div>
                <div class="kpi-val" style="color: #166534;">{{ $kpis['esi_covered'] }}</div>
            </td>
            <td class="kpi-card" style="width: 25%;">
                <div class="kpi-title">PT Covered</div>
                <div class="kpi-val" style="color: #854d0e;">{{ $kpis['pt_covered'] }}</div>
            </td>
        </tr>
    </table>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $r['client_name'] }}</td>
                <td class="text-center">{{ $r['pf_status'] }}</td>
                <td class="text-center">{{ $r['esi_status'] }}</td>
                <td class="text-center">{{ $r['pt_status'] }}</td>
                <td class="text-center">{{ $r['lwf_status'] }}</td>
                <td class="text-center">{{ $r['eps_status'] }}</td>
                <td>{{ $r['uan_number'] }}</td>
                <td>{{ $r['esi_number'] }}</td>
            </tr>
            @endforeach
