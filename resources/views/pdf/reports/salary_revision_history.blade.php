...
<head>
    <meta charset="utf-8">
    <title>Salary Revision & Promotion History Audit</title>
    <style>
    ...
    <table class="header-table">
        <tr>
            <td style="width: 50%;">
                ...
                <div class="meta-text">Salary Revision & Promotion History Audit</div>
            </td>
            <td style="width: 50%;" class="text-right">
                <div class="report-title">Salary Revisions</div>
    ...
    <table class="kpi-table">
        <tr>
            <td class="kpi-card" style="width: 25%;">
                <div class="kpi-title">Total Revisions</div>
                <div class="kpi-val">{{ $kpis['total_revisions'] }}</div>
            </td>
            <td class="kpi-card" style="width: 25%;">
                <div class="kpi-title">Approved</div>
                <div class="kpi-val" style="color: #166534;">{{ $kpis['approved_count'] }}</div>
            </td>
            <td class="kpi-card" style="width: 25%;">
                <div class="kpi-title">Pending</div>
                <div class="kpi-val" style="color: #854d0e;">{{ $kpis['pending_count'] }}</div>
            </td>
            <td class="kpi-card" style="width: 25%;">
                <div class="kpi-title">Avg Increment</div>
                <div class="kpi-val" style="color: #1e3a8a;">{{ $kpis['avg_increment'] }}</div>
            </td>
        </tr>
    </table>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th class="text-right">Old CTC (₹)</th>
                <th class="text-right">New CTC (₹)</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $r['old_designation'] }}</td>
                <td><strong>{{ $r['new_designation'] }}</strong></td>
                <td class="text-right">{{ number_format($r['old_ctc'], 2) }}</td>
                <td class="text-right"><strong>{{ number_format($r['new_ctc'], 2) }}</strong></td>
                <td class="text-center"><strong>{{ $r['increment_pct'] }}</strong></td>
