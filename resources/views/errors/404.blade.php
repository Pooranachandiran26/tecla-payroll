...
<head>
    ...
    <title>404 - Page Not Found | Tecla Payroll</title>
    <style>
        ...
        .icon-circle { width: 80px; height: 80px; border-radius: 50%; background-color: #EFF6FF; color: #2563EB; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem auto; font-size: 2.2rem; font-weight: bold; }
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <p>Sorry, the page or resource you are looking for could not be found or has been moved.</p>
            <div class="btn-group">
