...
class Gstr1Test extends TestCase
{
    ...
    public function generates_valid_gstr1_json_and_xlsx_files()
    {
        ...
        // Assert JSON file exists and is valid GSTR-1 structure
        ...
        // Assert Table 12 HSN Summary
        $this->assertNotNull($jsonContent['hsn']);
        $this->assertEquals('9985', $jsonContent['hsn']['data'][0]['hsn_sc']);
        $this->assertEquals(50000.00, $jsonContent['hsn']['data'][0]['txval']);
