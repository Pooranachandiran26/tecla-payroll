...
function PayrollApproval({ clients, selectedClientId, selectedMonth, run, items, preflight, cycleInfo, newHires = [], pendingSupplementaryRuns = [] }) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_RoleGuard.default, { allowedRoles: ["admin", "manager"], moduleKey: "payroll" }, /* @__PURE__ */ import_react.default.createElement(import_AuthenticatedLayout.default, null, /* @__PURE__ */ import_react.default.createElement(import_react2.Head, { title: "Payroll Approval" }), /* @__PURE__ */ import_react.default.createElement("div", { className: "mb-6 flex justify-between items-end flex-wrap gap-4" }, /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("h2", { className: "text-2xl font-bold text-[#1F3864] mb-1" }, "Approve & Lock Payroll Batch"), /* @__PURE__ */ import_react.default.createElement("p", { className: "text-gray-500 text-[0.9rem]" }, "Review consolidated totals and authorize bank file disbursements.")), run && (excludedItems.length > 0 || newHires.length > 0) && /* @__PURE__ */ import_react.default.createElement("div", { style: { backgroundColor: "#FFFBEB", border: "1px solid #FEF3C7", padding: "0.5rem 1rem", borderRadius: "var(--radius-sm)", fontSize: "0.85rem", color: "#92400E", display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "0.25rem" } }, /* @__PURE__ */ import_react.default.createElement("strong", null, "Partial Batch: ", activeItems.length, " of ", items.length, " employees processed."), /* @__PURE__ */ import_react.default.createElement("span", null, excludedItems.length, " excluded + ", newHires.length, " new hires \u2014 click 'Create Supplementary Run' to process them."), /* @__PURE__ */ import_react.default.createElement(
    ...
    newHires.length,
    " New Hires"
  ))), /* @__PURE__ */ import_react.default.createElement("div", { className: "card", style: { padding: "0.85rem 1rem", marginBottom: "1rem" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" } }, /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", alignItems: "center", gap: "1rem" } }, /* @__PURE__ */ import_react.default.createElement("label", { style: { fontWeight: 600, marginBottom: 0, color: "var(--primary-navy)" } }, "Select Client Batch:"), /* @__PURE__ */ import_react.default.createElement("select", { className: "form-control", style: { width: "280px" }, value: clientId, onChange: (e) => handleClientChange(e.target.value) }, clients.map((c) => /* @__PURE__ */ import_react.default.createElement("option", { key: c.id, value: c.id }, c.company_name))), /* @__PURE__ */ import_react.default.createElement("select", { className: "form-control", style: { width: "150px" }, value: month, onChange: (e) => handleMonthChange(e.target.value) }, getMonthOptions().map((opt) => /* @__PURE__ */ import_react.default.createElement("option", { key: opt.value, value: opt.value }, opt.label)))), /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", alignItems: "center", gap: "0.5rem", fontSize: "0.85rem" } }, /* @__PURE__ */ import_react.default.createElement("span", { style: { fontWeight: 500, color: "var(--text-muted)" } }, "\u2708\uFE0F Pre-Flight Gates:"), /* @__PURE__ */ import_react.default.createElement("span", { className: `badge ${preflight && preflight.some((f) => f.type === "red") ? "badge-danger" : "badge-success"}` }, preflight && preflight.some((f) => f.type === "red") ? "Blockers Found" : "All Clear"))), cycleInfo && /* @__PURE__ */ import_react.default.createElement("div", { className: "cycle-info-row", style: { display: "flex", gap: "1.5rem", borderTop: "1px solid var(--border-color)", paddingTop: "0.5rem", marginTop: "0.6rem", fontSize: "0.82rem", color: "var(--text-muted)", flexWrap: "wrap" } }, /* @__PURE__ */ import_react.default.createElement("span", null, "\u{1F4C5} Cycle Ends: ", /* @__PURE__ */ import_react.default.createElement("strong", null, cycleInfo.cycle_end_date)), cycleInfo.target_lock_date && /* @__PURE__ */ import_react.default.createElement("span", null, "\u{1F512} Target Lock Date: ", /* @__PURE__ */ import_react.default.createElement("strong", null, cycleInfo.target_lock_date)), cycleInfo.target_salary_credit_date && /* @__PURE__ */ import_react.default.createElement("span", null, "\u{1F4B0} Target Salary Credit: ", /* @__PURE__ */ import_react.default.createElement("strong", null, cycleInfo.target_salary_credit_date))), preflight && preflight.length > 0 && /* @__PURE__ */ import_react.default.createElement("div", { style: { borderTop: "1px dashed var(--border-color)", paddingTop: "0.5rem", marginTop: "0.5rem" } }, preflight.map((f, i) => /* @__PURE__ */ import_react.default.createElement("div", { key: i, className: `preflight-item status-${f.type}`, style: { padding: "0.3rem 0.6rem", margin: "0.2rem 0", fontSize: "0.8rem" } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "preflight-icon", style: { fontSize: "0.85rem" } }, f.type === "red" ? "\u274C" : f.type === "info" ? "\u2139\uFE0F" : "\u26A0\uFE0F"), /* @__PURE__ */ import_react.default.createElement("div", { className: "preflight-content" }, /* @__PURE__ */ import_react.default.createElement("strong", null, f.type === "red" ? "BLOCKER" : f.type === "info" ? "INFO" : "WARNING", ":"), " ", f.msg))))), run ? (() => {
    ...
    return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, /* @__PURE__ */ import_react.default.createElement("div", { className: "grid-cols-4", style: { marginBottom: "1rem" } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "card metric-card", style: { padding: "0.85rem 1rem" } }, /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-label" }, "Processed Employees"), /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-value", style: { fontSize: "1.4rem" } }, run.total_employees_processed), /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-trend text-muted" }, "Active in Roster")), /* @__PURE__ */ import_react.default.createElement("div", { className: "card metric-card", style: { padding: "0.85rem 1rem" } }, /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-label" }, "Total Gross Earnings"), /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-value", style: { fontSize: "1.4rem" } }, "\u20B9", parseFloat(run.total_gross_earnings).toLocaleString()), /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-trend text-muted" }, "Sum of gross pays")), /* @__PURE__ */ import_react.default.createElement("div", { className: "card metric-card", style: { padding: "0.85rem 1rem" } }, /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-label" }, "Total Net Disbursement"), /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-value", style: { color: "var(--primary-navy)", fontSize: "1.4rem" } }, "\u20B9", parseFloat(run.total_net_disbursement).toLocaleString()), /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-trend text-muted" }, "Amount sent to bank")), /* @__PURE__ */ import_react.default.createElement("div", { className: "card metric-card", style: { padding: "0.85rem 1rem" } }, /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-label" }, "Employer Statutory Cost"), /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-value", style: { color: "var(--status-warning)", fontSize: "1.4rem" } }, "\u20B9", parseFloat(run.total_employer_statutory_cost).toLocaleString()), /* @__PURE__ */ import_react.default.createElement("span", { className: "metric-trend text-muted" }, "Er PF + Er ESI + Er LWF"))), /* @__PURE__ */ import_react.default.createElement("div", { className: "grid-layout" }, /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", flexDirection: "column", gap: "1.25rem" } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "card" }, /* @__PURE__ */ import_react.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid var(--border-color)", paddingBottom: "0.5rem", marginBottom: "1rem" } }, /* @__PURE__ */ import_react.default.createElement("h3", { className: "card-title", style: { margin: 0 } }, "Employee Totals & Full Breakdown"), /* @__PURE__ */ import_react.default.createElement("button", { className: "btn btn-secondary btn-xs", onClick: () => setShowBreakdown(!showBreakdown) }, "Toggle Full Breakdown")), showBreakdown && /* @__PURE__ */ import_react.default.createElement("div", { style: { marginBottom: "1.5rem" } }, /* @__PURE__ */ import_react.default.createElement("div", { className: "table-responsive" }, /* @__PURE__ */ import_react.default.createElement("table", { className: "data-table", style: { fontSize: "0.8rem" } }, /* @__PURE__ */ import_react.default.createElement("thead", null, /* @__PURE__ */ import_react.default.createElement("tr", null, /* @__PURE__ */ import_react.default.createElement("th", null, "Emp Code"), /* @__PURE__ */ import_react.default.createElement("th", null, "Employee Name"), /* @__PURE__ */ import_react.default.createElement("th", null, "Gross Salary (\u20B9)"), /* @__PURE__ */ import_react.default.createElement("th", null, "Net Pay (\u20B9)"), /* @__PURE__ */ import_react.default.createElement("th", null, "Total Deductions (\u20B9)"), /* @__PURE__ */ import_react.default.createElement("th", null, "Employer Cost (\u20B9)"), /* @__PURE__ */ import_react.default.createElement("th", null, "Total Line CTC (\u20B9)"))), /* @__PURE__ */ import_react.default.createElement("tbody", null, items.map((item) => {
